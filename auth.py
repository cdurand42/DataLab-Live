"""Authentication and session management for DataLab-Live frontend.

Implements a fail-closed, secure login gate:
- Username + password verification.
- Passwords verified strictly via PBKDF2-HMAC-SHA256 (salted & iterated).
- No plain password support or fallback.
...
def render_login_form() -> None:
    ...
    with col2:
        ...
        st.caption("Accès restreint. Veuillez vous identifier pour accéder au portail.")
...
if __name__ == "__main__":
    import getpass
    print("Générateur de hash PBKDF2-HMAC-SHA256 pour LIVE_PASSWORD_HASH")
